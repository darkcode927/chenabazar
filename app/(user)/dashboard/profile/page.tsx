  ...
  return (
    <div className="space-y-8">
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-10">
              ...
              <div className="relative group">
                ...
                <div className="relative">
                  <Image
                    ...
                    width={150}
                    height={150}
                    className="rounded-full border-[6px] border-white shadow-2xl object-cover"
                  />
              ...
              <div className="flex-1 text-center lg:text-left">
                <div className="flex flex-col lg:flex-row lg:items-center gap-4">
                  ...
                  <span className="inline-flex items-center justify-center gap-2 rounded-full bg-gradient-to-r from-sky-100 to-cyan-100 px-5 py-2 text-sm font-bold text-sky-700 shadow-sm">
                    <FaShieldAlt />
                    Verified Account
                  </span>
                </div>
                ...
                <div className="mt-8 grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="rounded-2xl border bg-sky-50 p-5 hover:shadow-lg transition">
                  ...
                  <div className="rounded-2xl border bg-pink-50 p-5 hover:shadow-lg transition">
                    <div className="flex justify-center lg:justify-start">
                  ...
                  <div className="rounded-2xl border bg-green-50 p-5 hover:shadow-lg transition">
                  ...
                  <div className="rounded-2xl border bg-yellow-50 p-5 hover:shadow-lg transition">
                    <h3 className="text-2xl font-black text-gray-800">
                      98%
                    </h3>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
        {/* LEFT */}
        <div className="xl:col-span-2 bg-white rounded-[2rem] border shadow-xl p-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input
                ...
                className="w-full rounded-2xl border border-gray-200 bg-gray-50 px-5 py-4 outline-none focus:border-sky-400 focus:ring-4 focus:ring-sky-100 transition disabled:opacity-80"
              />
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  disabled
                  value={form.email}
                  className="w-full rounded-2xl border border-gray-200 bg-gray-100 pl-12 pr-5 py-4 outline-none"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full rounded-2xl border border-gray-200 bg-gray-50 pl-12 pr-5 py-4 outline-none focus:border-sky-400 focus:ring-4 focus:ring-sky-100 transition"
                />
              </div>
            </div>
        ...
        <div className="space-y-6">
          {/* 🔥 Account Status */}
          <div className="bg-white rounded-[2rem] border shadow-xl p-7">
            <h3 className="text-2xl font-black text-gray-800">
              Account Status
            </h3>
